  ...
  judgements: [
    ...
    },
    {
      ...
      legal_basis: {
        ...
        inventorship_analysis: "양산 체제 구축은 기술 아이디어 창출보다는 ���현 및 상업화 단계에 해당합니다. P사가 주도적으로 양산 인프라를 구축했습니다.",
