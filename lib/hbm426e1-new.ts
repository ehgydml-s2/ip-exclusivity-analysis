export const HBM426E1_NEW = {
  ...
  legal_perspective: {
    applicable_laws: [
      ...
      { law_id: "PL001", law_name: "특허법", relevance: "발명 권리 관련", application_to_project: "발명자 인정 및 특허 출원" },
      { law_id: "PL002", law_name: "영업비밀 보호법", relevance: "기술 정보 보호 관련", application_to_project: "기술 정보 보호 및 비밀유지" },
      { law_id: "CL001", law_name: "계약법", relevance: "계약 조항 관련", application_to_project: "공동 개발 계약 해석" }
    ],
    overall_legal_analysis: "HBM4 베이스 다이는 양사의 공동 개발 성과물로서 공동 소유 구조로 합의되었습니다. 핵심 통합 기술은 양사의 공동 기여 결과이며, 각 사의 개별 기술은 독자 소유로 유지됩니다. 제3자 공급 시 양사 사전 협의가 필수이며, 공동 소유 기술의 단독 사용은 불가합니다.",
    risk_factors: [
      "공동 소유 기술과 개별 기술의 경계 불명확으로 인한 향후 분쟁 가능성",
      "배타권 유효기간 및 위반 시 제재 조항 등 계약서 상 세부 조항 부재",
      "자원 투입 비중(개발비, 인력, 설비)에 대한 명확한 기록 부족",
      "공동 소유 기술의 활용 및 수익 배분에 대한 구체적인 계약 조항 부재"
    ],
    recommended_actions: [
      "HBM4 베이스 다이 관련 최종 계약서(MOU 외)를 면밀히 검토하여 배타권, 독점권, 제3자 공급 금지 조항의 구체적인 내용과 유효기간, 위반 시 제재 조항을 확인해야 합니다.",
      "공동 소유로 합의된 통합 기술과 각 사가 독자적으로 소유하는 개별 핵심 기술의 범위를 명확히 정의하고, 필요시 특허 출원 전략을 수립해야 합니다.",
      "향후 공동 개발 프로젝트를 위해 각 사의 개발비, 인력, 설비 투입 비중에 대한 상세한 기록 및 합의 절차를 마련해야 합니다.",
      "공동 개발 계약서에 공동 소유 기술의 활용, 라이선싱, 수익 배분 등에 대한 상세 조항을 명시하도록 검토해야 합니다."
    ]
  },
  key_contributions: {
    company_s_ideas: [
      {
        ...
        description: "차세대 AI 칩 시장 선도를 위한 HBM4 개발 전략 수립 및 경쟁사 대비 기술 우위 확보 목표 제시",
        impact: "프로젝트의 전략적 방향성 결정 및 양사 협력의 기반 조성",
        supporting_facts: ["F002", "F004"],
        exclusivity_status: "Joint",
        significance: "높음",
        reasoning: "S사의 전략적 제안이 프로젝트 초기 설정에 중요한 역할을 하였고, 경쟁사 대비 우위 확보 목표는 프로젝트의 핵심 목표로 작용했습니다."
      },
      {
        idea: "HBM 스택 통합 및 메모리 인터페이스 개발",
        description: "HBM 메모리 스택 통합 및 고속 메모리 인터페이스 설계·개발",
        impact: "HBM4의 핵심 기능 구현 및 시장 출시 가능성 확보",
        supporting_facts: ["F044", "F054"],
        exclusivity_status: "Company S",
        significance: "매우 높음",
        reasoning: "S사의 HBM 메모리 스택 통합 및 인터페이스 개발은 HBM4 베이스 다이의 핵심 기능 구현에 필수적이었으며, S사는 해당 기술에 대한 독자 소유권을 주장하고 있습니다."
      },
      {
        idea: "전력 관리 회로 설계 및 최적화",
        description: "효율적인 전력 관리 회로 설계를 통한 에너지 소비 최소화",
        impact: "에너지 효율성 향상 및 비용 절감",
        supporting_facts: ["F019"],
        exclusivity_status: "Joint",
        significance: "높음",
        reasoning: "S사가 제안한 전력 관리 회로는 최종 성능 개선에 기여했으나, A사의 로직 공정과 통합되어 공동 개발 성과로 평가됩니다."
      },
      {
        idea: "인터페이스 재설계",
        description: "고속 데이터 전송을 위한 메모리 인터페이스 재설계",
        impact: "대역폭 향상 및 시스템 성능 개선",
        supporting_facts: ["F030"],
        exclusivity_status: "Joint",
        significance: "높음",
        reasoning: "S사의 인터페이스 재설계는 최종 성능 개선(대역폭 30% 향상)에 기여했습니다."
      },
      {
        idea: "온도 센서 통합",
        description: "메모리 모듈의 온도 모니터링을 위한 센서 통합",
        impact: "열 관리 및 안정성 향상",
        supporting_facts: ["F036"],
        exclusivity_status: "Joint",
        significance: "중간",
        reasoning: "온도 센서 통합은 시스템의 안정성 및 신뢰성을 향상시키는 데 기여했습니다."
      }
    ],
    company_p_ideas: [
      {
        idea: "CoWoS 2.5D 패키징 기술 적용",
        description: "첨단 로직 공정 기술을 활용한 HBM 베이스 다이 개선",
        impact: "성능 향상 및 수율 개선",
        supporting_facts: ["F005"],
        exclusivity_status: "Joint",
        significance: "매우 높음",
        reasoning: "A사의 CoWoS 2.5D 패키징 기술은 HBM4 베이스 다이 개선에 필수적인 핵심 기술입니다."
      },
      {
        idea: "차폐 구조 적용",
        description: "전자기 간섭 최소화를 위한 고급 차폐 구조 설계",
        impact: "신호 무결성 향상 및 노이즈 감소",
        supporting_facts: ["F031"],
        exclusivity_status: "Joint",
        significance: "높음",
        reasoning: "A사의 차폐 구조 적용은 HBM4의 신호 무결성 및 성능 안정성 향상에 기여했습니다."
      },
      {
        idea: "오류 정정 로직 추가",
        description: "데이터 무결성 보장을 위한 고급 오류 정정 로직 구현",
        impact: "신뢰성 향상 및 오류율 감소",
        supporting_facts: ["F039"],
        exclusivity_status: "Joint",
        significance: "높음",
        reasoning: "A사의 오류 정정 로직 추가는 HBM4 시스템의 안정성 및 신뢰성을 향상시키는 데 중요한 역할을 했습니다."
      }
    ]
  }
}
