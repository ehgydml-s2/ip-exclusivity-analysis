    ...
    judgements: [
      ...
      },
      {
        ...
        legal_basis: {
          ...
          contribution_analysis:
            "S사는 영업비밀로 지정된 기술의 개발에 주��적으로 기여했으며, 협력사는 S사의 영업비밀을 보호하고 관리하는 역할을 수행했습니다.",
          risk_factors: [
      ...
      applicable_laws: [
        {
          ...
          application_to_project:
            "본 프로젝트에서 S사는 HKMG 공정용 세정 레시�� 및 공정 기술에 대한 아이디어를 최초 제안하고 10년간 독자 개발했습니다(F002, F012, F017). 협력사는 S사의 지시에 따라 장비를 구현하는 역할을 수행했으므로, 발명자 인정 측면에서 S사가 우위에 있습니다.",
        },
        {
          law_id: "CL002",
  ...
  HSP20E1: {
    ...
    legal_perspective: {
      ...
      recommended_actions: [
        ...
        "양산 공급 계약서의 지적재산권 귀속 조항을 법무팀���서 면밀히 검토하고 필요시 보완해야 합니다."
      ]
    },
    elapsed_time: 266.91,
    ...
    judgements: [
      ...
      },
      {
        ...
        legal_basis: {
          ...
          recommended_legal_actions: ["공정 기술에 대한 권리 귀속 조항을 계약서에 명확히 ���함하고, S사의 독점적 사용을 보장하는 전용 실시권 또는 공동 소유를 검토할 것."]
        },
        evaluation_grade: {
          tech_effect_grade: "N/A",
          tech_effect_reasoning: "N/A - 소재 과제",
      ...
      },
      {
        ...
        legal_basis: {
          ...
          contribution_analysis: "S사는 개발 완료 및 배타권 확보의 최종 단계에서 주도적인 ��할을 수행했습니다.",
    ...
    legal_perspective: {
      applicable_laws: [
        ...
        },
        {
          law_id: "CV001",
          law_name: "민법 제654조 (공유물의 관리)",
          relevance: "공동 소유물의 관리는 공유자 과반수의 지분으로 결정합니다. 공동 개발 시 각자의 기여도에 따라 지분 ���율을 정할 수 있습니다.",
