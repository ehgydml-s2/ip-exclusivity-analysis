...
import { SNPR20E1_JUDGEMENTS } from "./snpr20e1-judgements"
...
export type Judgement = {
  ...
  claimed_holder: ExclusivityHolder
  fact_count: number
...
export type KeyContributions = {
  company_s_ideas: KeyContribution[]
  company_p_ideas: KeyContribution[]
}
...
export const meetingMinutes: MeetingMinute[] = [
  ...
  },
  {
    ...
    date: "2024-10-25",
    companyS: `협���업��� 프로토타입 장비로 당사 세정 레시피 적용 테스트 완료\nHKMG 공정 세정 효율 95% 달성 - 당사 독자 레시피의 우수성 검증\n다만 일부 웨이퍼에서 잔류물 발생 - 장비 ��스 공정 개선 필요\n당사 레시피��� 그대로 ��지, 장비 측면 개선으로 해결 요청`,
  ...
  // ---- HWM25E1 (설비) ----
  {
    ...
    date: "2023-07-25",
    companyS: `S사 기술혁신기업 프로그램 7�� 선정 - 코비스테���놀로지 하이브리드 웨��퍼 계측 장비 개발 과제 착수\n반도체 장비 국산화 전략의 ���환으로 웨��퍼 계측 기술 자립화 필요\n최대 3년�� 공동 기술개발, 무이��� 자금 대출, 경영컨설팅 ��원 제공\n기술혁신기업 프로그램 통해 지난해 850억원 사회적 가치 창출 실적`,
  ...
  },
  {
    ...
    articleUrl: "https://news.skhynix.co.kr/technology-innovation-7th-2/",
    scenarioNote: `[명확한 독자 개발 시나리오 - 장비 국산화형]\n목적: Company A가 독자 기술로 장비 개���, Company S는 평가/피드백만 제공한 케이스\n- Company S: 사양 정의, 성능 평가, 피드백 제공 (일반적 수요자 역할)\n- Company A: 하이브리드 계측 기술 독자 개발 및 구현 (완전 독자 기술)\n→ Company A 독자 기술, Company S는 수요자 역할만\n→ Agent가 "배타권 없음, 일반 공급 계약" 판정 기대`,
  },
  {
    id: "HWM25E1_04",
    numId: 90,
    projectCode: "HWM25E1",
    projectType: "설비",
    title: "개선 프로토타입 성능 검증 및 피드백 반��� 확인",
    date: "2024-07-25",
  ...
  },
  {
    ...
    articleUrl: "https://www.sedaily.com/article/13774334",
    scenarioNote: `[명확한 배타권 근거 시나리오 - 첨가제 제안형]\n목적: Company S가 독자 개발한 첨가제로 원천 기술의 결함을 해결하여 배타권 확보\n- Company A: Silica 입자 원천 기술 보유 (하지만 성능 부족으로 양산 불가)\n- Company S: 독자 개발 첨가제(Additive-X) 제안 → ��능 결함 완전 해결\n→ Company S의 첨가제가 양산 성공의 핵심 기여\n→ Agent가 "배���권: Company S (Additive-X 적용 제품에 한정, 5년간 제3자 공급 금지)" 판정 기���`,
  },
  {
    id: "SCMP26E1_05",
    numId: 97,
    ...
    articleUrl: "https://www.sedaily.com/article/13774334",
    scenarioNote: `[명확한 배타권 근거 시나리오 - 첨가제 제안형]\n목적: Company S가 독자 개발한 첨��제로 원천 기술의 결함을 해결하여 배타권 확보\n- Company A: Silica 입자 원천 기술 보유 (하지만 성능 부족으로 양산 불가)\n- Company S: 독자 개발 첨가제(Additive-X) 제안 �� 성능 결함 완전 해결\n→ Company S의 첨가제가 양산 성공의 핵심 기여\n→ Agent가 "배타권: Company S (Additive-X 적용 제품에 한���, 5년간 제3자 공급 금지)" 판정 기대`,
  },
  {
    id: "SCMP26E1_06",
    numId: 98,
    ...
    date: "2026-03-04",
    companyS: `Pilot 롯트 평가 결과 품질 산포가 안정적이며 양산성 확보가 완료되었음을 확인하여 최종 기술 승인을 통보함. 본 제품은 기술 심의회를 거쳐 당사 내부 '배타권 자��� DB'에 ���식 등록될 예정임. 구매팀 주도로 양산 공급 계약 ��� 배타권 위반 시 페널티 조항�� 포함한 정식 계약 체결 절차를 진행��겠음.`,
  ...
  },
  {
    ...
    articleUrl: "https://www.etnews.com/20251205000260",
    scenarioNote: `[명확한 배타권 근거 시나리오 - 구조 최적화형]\n목적: Company S의 단계적 기술 개선 제안이 핵심 성과로 이어진 케이스\n- Company S: 분지형 리간드 제안 (회의록 02) → 말단 할로겐 치환 제안 (회의록 04)\n- Company A: 원천 Sn 기술 보유, Company S 제안 구조 합성\n→ 양산 성공의 결���적 기여는 Company S의 구��� 제안\n→ Agent가 "배타권 귀속: Company S, 특정 구조체(IP-B21-F)에 한정" 판정 기대`,
  },
  {
    id: "SNPR20E1_08",
    numId: 106,
  ...
  },
  {
    ...
    articleUrl: "https://v.daum.net/v/6vJbh7TNCr",
    scenarioNote: `[모호한 기여도 판단 시나리오]\n목적: 계측 장�� 국산화 과제에서 양측 기여도가 불명확한 경우 배타권 판별 테���트\n- Company S: 사양 정의 + 일부 구체적 기술 조언 (센서 배치, 알고리즘 로직 제안)\n- Company A: 기술 구현 + 독자 개발 부분 (예측 제어 로직)\n→ 공동 기여 vs 개별 기여 경계가 모호한 케이스\n→ Agent가 "기여도 불명확, 추가 증거 필요" 판정 기대`,
  },
  {
    id: "WPC22E1_04",
    numId: 112,
    projectCode: "WPC22E1",
    projectType: "설비",
    title: "개선 프로토타입 성능 검증 ��� 피드백 반영 확인",
    date: "2021-08-25",
...
function buildSnpr20e1Facts(): Fact[] {
  return (snpr20e1FactRecords as RawFactRecord[]).map((r) => ({
    id: r.FACT_ID,
    text: r.FACT,
    originalText: r.ORIGINAL_TEXT,
    speaker: normalizeSpeaker(r.SPEAKER),
...
export const analysisResults: Record<string, AnalysisResult> = {
  HKMG25E1: {
    ...
    overall_conclusion: {
      summary:
        "본 프로젝트에서 S사는 HKMG 공정��� 세정 레시피 및 관련 공정 기술에 대한 독점적인 배타권을 강력하게 주장하고 있으며, 협력사는 S사의 지시와 통제 하에 해당 레시피를 구현하는 전용 장비의 설계 및 제조를 담당했습니다. 모든 핵심 기술 정보는 S사의 영업비밀로 지정되었고, 협력사는 이에 대한 엄격한 비밀 유지 및 제3자 제공 금지 의무를 수용했습니다. 따라서, 핵심 기술인 세정 레시피 및 공정 기술과 이를 구현하는 장비에 대한 배타권은 Company S에 귀속됩니다.",
      overall_exclusivity_assessment: "Company S",
      confidence_level: "Medium",
      key_risks: [
        "협력사�� 장비 설계 및 제조 과정에서 독자적으로 개발한 미세 기술 개선 사항에 대한 권리 주장 가능성",
        "계약서에 명시된 배타권 조항의 구��적인 범위 및 유효기간에 대한 불명확성 (회의록 상 명시적 계약서 조항은 ��음)",
        "협력사 내부 인력의 ���직 등으��� 인한 기술 유출 위험",
      ],
      recommendations: [
    ...
    judgements: [
      ...
      },
      {
        ...
        recommendation:
          "장비 자체��� 대한 특허 출원 가능성을 검토하고, S사 레시�� 구현 전용 장비임을 명시하는 계약 조��을 강화하여 협력사의 타사 공급을 원천적으로 차단할 것.",
        legal_basis: {
      ...
      },
      {
        ...
        legal_basis: {
          ...
          contract_analysis: {
            has_exclusivity_clause: true,
            clause_summary:
              "S사는 세정 레시피, HKMG 공정 기술, 장비 사양을 영업비밀로 최종 확정하고(F065), 협력업체는 S사 기술 보호 의무를 지���하며 위반 �� 민형사상 책임 추궁(F067) 및 제3자 공급 금지(F056, F070)를 명시했습니다. 협력사는 S사 기술 비밀 유지 서약(F060, F069) 및 제3자 공유 금지(F062, F070)를 약속했습니다.",
            validity_period: "정보 부족 (회의록 상 명시적 유효기간 언급 없음)",
            enforcement_risk:
              "S사의 명시적인 영업비밀 지정 및 보호 의지와 협력사의 수용 및 이행 의지가 명확하게 확인되어 법적 집행 가능성이 매우 높습니다.",
          },
          inventorship_analysis:
            "기술 아이디어의 창출은 S사에서 이루어졌으며, 보호 대상인 영업비밀은 S사의 독자��인 연구 개발 결과물입니다.",
          contribution_analysis:
            "S사는 영업비밀로 지정된 기술의 개발에 ����적으로 기여했으며, 협력사는 S사의 영업비밀을 보호하고 관리하는 역할을 수행했습니다.",
          risk_factors: [
            "협력사 내부에서 영업비밀 관리 소홀로 ���한 유출 발생 시 책임 소재 및 손해배상 범위 입증의 어려움",
          ],
          recommended_legal_actions: [
            "협력사와의 계���서에 영업비밀의 정의, 범위, 보호 의무, 위반 시 손해배상액 예정 등 구체적인 조항을 포함했는지 법무팀 검토 필요.",
          ],
        },
        evaluation_grade: {
          tech_effect_grade: "1",
          ...
          competitor_applicability: "고",
          competitor_reasoning:
            "S사 레시피의 외부 ���개 시 '경쟁사 기술 격차 해소에 직결'(F018)된��고 명시되었고, '해외 경쟁사'에게 정보 제공을 절대 금지하는 등(F056, F063, F070) 타사에 노출될 경우 적용 용이성이 높아 기술 격차 유지를 위해 보호가 필수적입니다.",
          tech_gap: "대",
          tech_gap_reasoning:
    ...
    legal_perspective: {
      applicable_laws: [
        {
          ...
          relevance:
            "발명자 인정 기준은 기술적 아이디어를 창출한 자에게 특허를 받을 수 있는 권리가 있음을 명시합니다. 이�� 배타권 주체의 핵심 근거가 됩니다.",
        ...
        },
        {
          ...
          application_to_project:
            "회의록 상 S사는 세정 레시피 및 공정 기술을 영업비밀로 최종 확정하고(F047, F065), 협력업체의 역할을 S사 레시피 기반 장비 제조로 제한하며 레시피의 독점 소유권을 명시했습니다(F048). 협력사 또한 S사 기술에 대한 ��밀 유지 및 제3자 공유 금지를 서약하고(F009, F060, F069, F070), 위반 시 법적 책임 및 계약 해지 조항을 재확���했습니다(F057, F067). 이는 계약서에 배타적 독점권 조항이 포함되어 있을 가능성이 매우 높음을 시사하며, S사의 배타권 주장에 강력한 법적 근거가 됩니다.",
        },
        {
          law_id: "CL001",
      ...
      overall_legal_analysis:
        "본 프로젝트의 배타권은 S사에 강력하게 귀속될 것으로 판단됩니다. S사는 핵심 기술인 세정 레시피 및 공정 기술을 독자적으로 개발하고 ��업비밀로 지정했으며, 협력사는 S사의 지시와 통제 하에 해당 기술을 구현하는 장비의 설계 ��� 제조를 담당했습니다. 다수의 회의록 Fact에서 S사의 명시적인 배타권 의사 표현과 협력사의 비밀 유지 및 제3자 제공 금지 서약이 확인되어 계약법적 근거가 매우 견고합니다. 특허법적 관점에서도 S사가 기술 아이디어를 창출하고 선행 기술을 보유했으므로 발명자 인정에 유리합니다. 협력사의 기여는 S���의 기술을 구현하는 도급 계약의 성격이 강하며, 장비 자체도 S사 레시피 전용으로 개발되었습니다. 따라서 S사의 배타권 주장은 법적으로 높은 타당성을 가집니다.",
      risk_factors: [
        "협력사와의 정식 계약서에 회의록에서 언급된 배타권 및 영업비밀 보호 조항이 명확하고 구체적으로 명시되어 있지 않을 경우 법적 분쟁 발생 가능성",
        "협력사가 장비 설계 및 개선 과정에서 독자적으로 개발한 특정 기술적 요소에 대해 권리를 주장할 경우, 해당 부분에 대��� 기여도 및 권리 귀속 범위에 대한 이견 발생 가능성",
  ...
  HSP20E1: {
    ...
    legal_perspective: {
      ...
      recommended_actions: [
        "P사의 소재 관련 ��허 출원 및 등록 현황을 확인하�� 객관적 근거를 확보해야 합니다.",
        "양산 공급 계약서의 지적재산권 귀속 조��을 법무팀���서 면밀히 검토하고 필요시 보완해야 합니다."
      ]
    },
    elapsed_time: 266.91,
  ...
  HBM20C01: {
    ...
    project_type: "소재",
    overall_conclusion: {
      summary: "본 프로젝트에서 HBM TSV 공정용 CMP 슬러리 기술의 배타권은 협력사(Partner)에게 강력하게 귀속됩니다. 협력���는 해당 기술에 대한 독점적인 선행 기술과 특허를 보유하고 있었으며, S사의 요구사항에 맞춰 개발을 수행하고 생산 설비에 투자했습니다. S사는 이 기술을 독점적으로 공급받기 위해 상당한 일시금과 로열티를 지불하고, 협력사의 기술 보호 요구사항을 수용하는 배타적 기술협력 계약을 체결했습니다.",
      overall_exclusivity_assessment: "Partner",
      confidence_level: "High",
      key_risks: [
        "S사가 기술이전 받은 최��� 혼합 공정만으로 유사 기술을 개발하거나, P사의 핵심 배���비를 우회하여 개발할 경우 P사의 배타권 침해 가능��이 발생할 수 있습니다.",
    ...
    judgements: [
      {
        ...
        exclusivity_holder: "Partner",
        confidence: "High",
        reasoning: "P사는 TSV 공정 특화 슬러리 조성에 대한 독점적 기술 노하우를 10년간 축적해왔으며, S사의 구체적인 요청에 따라 개선 버전 개발에 착수하고 기술적 해결책을 제시하는 등 실제 개발을 ��도했습니다.",
        supporting_facts: ["F005", "F006", "F012", "F022", "F081"],
        counter_arguments: "S사가 초기 기술 아이디어를 ��안하고 구체적인 개선 방향을 제시했으며, 차세대 기술 공동 개발을 제안한 점은 S사의 기여로 볼 수 있습니다.",
      ...
      },
      {
        group_id: "G002",
        topic: "제품 성능 및 품질 관리",
        issue: "성능 목표 설정 및 달성 주체",
        exclusivity_holder: "Partner",
        confidence: "Medium",
        reasoning: "S사가 CMP 슬러리의 구리 제거율, 표면 거칠기, 균일도 등 구체적인 성능 목표와 품질 기준을 제시하고 개선을 요청하며 최종 사양을 확정했습니다. 그러나 P사는 S사의 요구사항을 충족하는 샘플을 개발하고, 구체적인 기술적 해결 방안을 제시했으며, 자체 QC 시스템을 통해 품질을 유지하고 있음을 강조했습니다. S사가 요구사항을 제시하고 P사가 이를 달성하는 형태이므로, 기술 자체의 배타권은 P사에게 있으나, S사가 제품의 품질 기준을 주도적으로 관리하고 있습니다.",
        supporting_facts: ["F009", "F021", "F055", "F016"],
        counter_arguments: "S사가 모든 성능 목표와 품질 기준을 제시하고, 개선을 요청하며, 최종 사양을 확정하고 검증했다는 점은 S사의 기술 주도권을 보여줍니다.",
        recommendation: "S사가 제시한 품질 기준을 P사가 어떻게 자체 기술로 달성했는지에 대한 기술적 상세 내용을 추가로 확인하여 P사의 기술적 기여도를 명확히 해야 합니다.",
        legal_basis: {
          applicable_laws: [],
          contract_analysis: {
            has_exclusivity_clause: false,
          ...
          inventorship_analysis: "P사가 S사의 요구사항을 충족시키기 위한 기술적 해결책을 개발하고 구현했으므로, 해당 개선 기술에 대한 발명자는 P사 직원이 될 가능성이 높습니다.",
          contribution_analysis: "S사는 성능 목표와 품질 기준을 제시하고 평가하는 데 기여했으며, P사는 이를 달성하기 위한 기술 개발 및 자체 품질 관리 시스템을 통해 기여했습니다.",
          risk_factors: ["S사의 구체적인 요구사항이 P사의 기술 개발에 미친 영향에 대한 기여도 분쟁 가능성."],
          recommended_legal_actions: ["S사가 제시한 성능 목표 달성을 위한 P사의 구체적인 개발 과정 및 기술적 노하우에 대한 문서화 및 검토가 필요합니다."]
        },
        evaluation_grade: {
          tech_effect_grade: "N/A",
          tech_effect_reasoning: "N/A - 소재 과제",
      ...
      },
      {
        group_id: "G003",
        topic: "공급 및 생산 관리",
        issue: "생산 및 공급 능력 확보 주체",
        exclusivity_holder: "Partner",
        confidence: "High",
        reasoning: "S사가 비용 절감 및 안정적 공급망 확보를 목표로 프로젝트를 시작하고, 월 공급량 확대 계획 및 공급 안정성 보증, 긴급 공급 중단 시 대체 방안 의무화 등 공급 관련 요구사항과 결정을 제시했습니다. 이에 대해 P사는 S사의 요구를 충족시키기 위해 생산 설비 증설에 착수하고, 긴급 공급 대비 안전재고를 확보하는 등 상당한 자원을 투입하여 공급 능력을 확보했습니다. 이는 P사가 S사의 요구에 맞춰 생산 및 공급 역량을 구축했음을 명확히 보여줍니다.",
        supporting_facts: ["F056", "F057", "F079", "F080"],
        counter_arguments: "S사가 공급 및 생산에 대한 사업적 목표와 요구사항을 제시하고 결정했다는 점은 S사의 사업 주도권을 보여줍니다.",
        recommendation: "P사의 생산 설비 증설 및 안전재고 확보에 대한 S사의 재정적 지원 여부를 확인하여 자원 투입 기여도를 명확히 해야 합니다.",
        legal_basis: {
          applicable_laws: [],
          contract_analysis: {
            has_exclusivity_clause: false,
          ...
          inventorship_analysis: "생산 및 공급 관리는 기술 개발보다는 운영 및 인프라 구축에 해당하��로, 직접적인 발명자 인정과는 거리가 있습니다.",
      ...
      },
      {
        group_id: "G004",
        topic: "지식재산권 및 계약 조건",
        issue: "배타적 권리 귀속 및 계약 조건",
        exclusivity_holder: "Partner",
        confidence: "High",
        reasoning: "P사는 CMP 슬러리 조성에 대한 특허를 단독 소유하고 있음을 명확히 밝혔으며, 제3자 이전 및 역설계 방지, 핵심 배합비 비공개, 기술이전 범위 제한 등 자사의 지식재산권과 배타적 권리를 보호하려는 강력한 의지를 일관되게 표명했습니다. S사는 P사의 기술을 독점적으로 공급받기 위해 협상에 착수하고, P사의 기술 보호 요구를 상당 부분 수용하며 일시금 40억 원과 매출의 2.7% 로열티를 지불하기로 합의했습니다. 최종 ETCA 계약 체결을 통해 S사는 3년간 독점 공급을 받기로 했으나, P사는 자사 CMP 슬러리 기술의 독점적 지위를 확보했다고 명시했습니다. 이는 P사가 기술의 원천 소유자로서 배타권을 가지며, S사는 그 사용권을 확보한 것으로 판단됩니다.",
        supporting_facts: ["F007", "F013", "F014", "F024", "F032", "F033", "F034", "F035", "F036", "F045", "F059", "F065", "F074", "F078"],
        counter_arguments: "S사가 배타적 공급 계약 협상을 제안하고, 독점 공급 기간을 수용하며, 경쟁사 제한 조항 완화를 요청하는 등 독점적 지위 확보를 위한 적극적인 노력을 기울였습니다. 또한 P사가 S사의 국내 경쟁사 공급 금지 제안에 동의하고, 미국/유럽 고객사 제한 제외에 동의한 점은 S사의 사업 확장에 유리한 조건입니다.",
        recommendation: "ETCA 계약서의 모든 조항, 특히 독점 공급 범위, 기술이전 범위, 경쟁사 제한 조건, 계약 해지 및 위약금 조항에 대해 법무팀의 면밀한 검토를 통해 S사의 권리 및 의무를 명확히 하고, 향후 분쟁 발생 시 S사의 입장을 강화할 수 있는 방안을 마련해야 합니다.",
        legal_basis: {
          applicable_laws: ["PL001", "CL002", "CL001"],
          contract_analysis: {
            has_exclusivity_clause: true,
            clause_summary: "ETCA 계약을 통해 P사의 CMP 슬러리 기술에 대한 3년간 독점 공급 및 P사의 독점적 지위 확보가 명시되었습니다. P사는 제3자 이전 및 역설계 방지, 핵심 배합비 비공개, 기술이전 범위 제한 등 강력한 배타권 특약 조항을 요구했고, S사는 이를 수용했습니다.",
            validity_period: "독점 공급 기간 3년",
          ...
          contribution_analysis: "P사는 기술 개�� 및 특허 확보에 대한 원천적 기여를 했으며, S사는 이 기술의 독점적 사용을 위�� 상당한 비용(일시금 40억 원 + 로열티 2.7%)을 지불했습니다. P사의 기술적 기여가 압도적입니다.",
      ...
      {
        group_id: "G005",
        topic: "HBM 공정 적용 및 최적화",
        issue: "공정 적용 및 최적화 주체",
        exclusivity_holder: "Company S",
        confidence: "Medium",
        reasoning: "S사가 HBM 12단 적층 공정에서의 안정성 추가 검증을 요청하고, 논의된 사양을 HBM 양산 표준으로 채택하는 등 공정 적용 및 최적화에 대한 요구사항을 제시하고 최종 결정을 내렸습니다. P사는 S사의 요청에 따라 장기 안정성 데이터를 제공하겠다고 제안하는 역할을 수행했습니다. 이는 S사가 자사의 HBM 공정에 P사의 슬러리 기술을 적용하고 최적화하는 과정에서 주도적인 역할을 했음을 보여줍니다. 슬러리 소재 자체의 배타권과는 별개로, 이 소재가 적용되는 공정 기술에 대한 주도권은 S사에게 있습니다.",
        supporting_facts: ["F019", "F028"],
        counter_arguments: "P사가 S사의 요청에 따라 12단 적층 공정 대응을 위한 장기 안정성 데이터를 제공하겠다고 제안한 점은 P사의 기술적 대응 능력을 보여줍니다.",
        recommendation: "S사가 P사의 슬러리 기술을 자사 공정에 적용하고 최적화하는 과정에서 발생한 새로운 공정 기술 또는 노하우에 대한 권리 귀속을 명확히 해야 합니다.",
        legal_basis: {
          applicable_laws: [],
          contract_analysis: {
            has_exclusivity_clause: false,
          ...
          inventorship_analysis: "S사가 자사 공정에 P사의 슬러리를 적용하며 발생한 공정 최적화 기술에 대한 발명자는 S사 직원이 될 가능성이 높습니다.",
          contribution_analysis: "S사는 공정 적용 및 최적화에 대한 요구사항을 제시하고 최종 결정을 내렸으며, P사는 슬러리 소재의 성능 데이터를 제공하는 데 기여했습니다.",
          risk_factors: ["P사의 슬러리 기술이 S사의 공정 ��적화에 필수적인 기여를 했다고 주장할 경우, 공정 기술에 대한 공동 권리 주장 가능성."],
          recommended_legal_actions: ["S사의 HBM 공정 최적화 과정에서 발생한 기술적 성과에 대한 특허 출원 가능성을 검토하고, P사의 슬러리 기술과의 경계를 명확히 해야 합니다."]
        },
        evaluation_grade: {
          tech_effect_grade: "N/A",
          tech_effect_reasoning: "N/A - 소재 과제",
      ...
      },
      {
        group_id: "G006",
        topic: "기타",
        issue: "사업적 동기 및 제품화 노력",
        exclusivity_holder: "Unclear",
        confidence: "Low",
        reasoning: "S사가 해당 기술의 국산화 성공 시 HBM 생산 경쟁력 강화라는 사업적 기대를 표명한 것으로, S사의 프로젝트 추진 동기를 보여줍니다. P사가 개발 중인 제품에 고유 제품명을 부여한 것으로, P사의 제품화 노력과 해당 기술에 대한 소유권 주장을 간접적으로 뒷받침합니다. 이 두 사실은 배타권 판단에 직접적인 영향을 주기보다는 각 사의 역할과 기여를 보완하는 정보입니다.",
        supporting_facts: ["F004", "F031"],
        counter_arguments: "N/A",
        recommendation: "이러한 사실들은 배타권 판단의 보조 자료로 활용하고, 핵심적인 계약 조항 및 기술 개발 기여도에 집중하여 판단해야 합니다.",
        legal_basis: {
          applicable_laws: [],
          contract_analysis: {
            has_exclusivity_clause: false,
          ...
          inventorship_analysis: "사업적 기대와 제품명 부여는 직접적인 발명자 인정 근거는 아닙니다.",
          contribution_analysis: "사업적 동기와 제품화 노력으로, 직접적인 자원 투입 비중을 판단하기 어렵습니다.",
          risk_factors: [],
          recommended_legal_actions: []
        },
        evaluation_grade: {
    ...
    legal_perspective: {
      applicable_laws: [
        ...
        },
        {
          law_id: "CL002",
          law_name: "계약 특약 조항 배타적 독점권 조항",
          relevance: "계약서에 명시된 배타적 독점권, 제3자 공급 금지, 전용 실시권 등의 조항은 권리 귀속 및 사용 범위를 결정하는 핵심 근거가 됩니다.",
          application_to_project: "ETCA 계약을 통해 P사의 기술에 대한 3년간 독점 공급 및 P사의 독점적 지위 확보가 명시되었으며, P사는 제3자 이전 및 역설계 방지, 핵심 배합비 비공개 등 강력한 배타권 조항을 요구했고 S사가 이를 수용했습니다."
        },
        {
          law_id: "PL002",
          law_name: "특허법 제10조~제15조 (직무발명)",
          relevance: "종업원의 직무상 발명에 대한 권리 귀속 및 보상에 관한 규정으로, 협력사 직원이 개발한 기술의 소유권이 협력사에 귀속될 수 있는 근거가 됩니다.",
          application_to_project: "P사 직원이 CMP 슬러리 기술을 개발한 경우, 해당 기술은 P사의 직무발명으로 P사에 권리가 귀속될 가능성이 높습니다. S사는 P사의 기술을 사용하기 위해 라이선스 비용을 지불했습니다."
        },
        {
          law_id: "CL001",
          law_name: "계약법 (민법 제664조) 도급계약 - 일의 완성과 보수",
          relevance: "도급계약에서 일의 완성에 따른 결과물의 소유권은 계약서에 명시된 조항에 따릅니다.",
          application_to_project: "S사가 P사에게 CMP 슬러리 개발을 요청하고 P사가 이를 완성한 도급적 성격이 있으나, P사의 선행 기술 및 특허권 주장이 강하고 S사가 라이선스 비용을 지불했으므로, 결과물의 소유권은 P사에게 귀속되고 S사는 사용권을 가집니다."
        }
      ],
      overall_legal_analysis: "본 프로젝트에서 CMP 슬러리 기술에 대한 배타권은 협력사(P사)에게 강력하게 귀속됩니다. P사는 해당 기술에 대한 독점적인 선행 기술과 특허를 보유하고 있었으며, 이는 특허법 제33조 및 직무발명 규정(PL001, PL002)에 따라 P사의 발명자 권리를 ���받침합니다. S사는 P사의 기술을 독점적으로 사용하기 위해 배타적 기술협력 계약(ETCA)을 체결하고, 일시금 40억 원과 로열티 2.7%를 지불하기로 합의했습니다. 이 계약에는 P사의 기술에 대한 3년간 독점 공급 및 P사의 독점적 지위 확보 조항(CL002)이 명시되어 있으며, P사는 기술이전 범위 제한, 역설계 방지, 핵심 배합비 비공개 등 강력한 기술 보호 조항을 요구하여 관���시켰습니다. 따라서 S사는 계약에 명시된 기간 동안 P사의 기술이 적용된 CMP 슬러리를 독점적으로 공급받을 권리를 가지지만, 기술 자체의 소유권 및 배타권은 P사에게 있습니다.",
      risk_factors: [
        "S사가 기술이전 받은 최종 혼합 공정만으로 유사 기술을 개발하거나, P사의 핵심 배합비를 우회하여 개발할 경우 P사의 배타권 침해 가능성이 발생할 수 있습니다.",
        "P사가 해외 시장(특히 중국/대만)에서 S사의 경쟁사에 기술을 공급할 경우, S사의 독점적 지위가 약화될 수 있으며, 사전 승인 조건의 해석 및 적용에 대한 분쟁 가능성이 있습니다.",
        "계약 해지 시 위약금 면제 조건이 P사의 재정적 리스크를 줄여 S사의 협상력을 제한할 수 있습니다."
      ],
      recommended_actions: [
        "ETCA 계약서 상의 독점 공급 기간, 기술이전 범위(특히 핵심 배합비 비공개), 경쟁사 제한, 계약 해지 조건, 위약금 조항 등을 법무팀에서 상세히 검토하여 S사의 권리 보호를 강화할 방안을 모색해야 합니다.",
        "기술이전 받은 최종 혼합 공정의 범위와 P사의 핵심 배합비 비공개 조항에 대한 법적 검토를 통해 S사의 기술 개발 가능성 및 P사의 기술 보호 범위를 명확히 해야 합니다.",
        "해외 고객사(특히 중국/대만)에 대한 P사의 공급 승인 절차 및 조건에 대해 추가적인 법적 검토 및 명확화가 필요하며, 필요시 추가적인 계약 조항을 협의해야 합니다."
      ]
    },
    elapsed_time: 258.44,
    ...
    judgements: [
      {
        ...
        exclusivity_holder: "Company S",
        confidence: "High",
        reasoning: "S사는 차세대 공정 요구사항을 제시하고(F001), P사 원천 기술의 한계(F009, F012, F013)를 진단한 후, 'Additive-X'라는 고유의 기술 아이디어를 ��안했습니다(F014). 이 Additive-X는 P사 Silica 포뮬러의 치명적 결함(겔��� 현상)을 해결하고 성능을 획기적으로 개선하는 데 결정적인 역할을 했음이 P사에 의해 확인되었습니다(F016). S사는 Additive-X 기술 및 최적 배합비가 S사 주도로 도출된 결과임을 명시했고(F020), P사도 S사가 독자 개발한 Additive-X 및 최종 혼합 Slurry 제품(Soul-S2)에 대한 S사의 배타적 사용 권리를 수용했습니다(F029, F030). 이는 S사가 핵심 기술 아이디어를 제안하고 개발을 주도하여 최종 제품의 성능을 결정적으로 개선했음을 명확히 보여줍니다.",
        supporting_facts: ["F001", "F003", "F004", "F007", "F008", "F009", "F010", "F012", "F013", "F014", "F015", "F016", "F018", "F020", "F021"],
        ...
        legal_basis: {
          ...
          contribution_analysis: "S사는 핵심 기술 아이디어 제안 및 문제 해결에 결정적으로 기여했으며, P사는 기존 Silica 원천 기술 제공 및 S사 아이디어 기반의 샘플 최��화에 기여했습니다. S사의 기여도가 더 높습니다.",
      ...
      {
        group_id: "G002",
        topic: "CMP 공정 성능 및 평가",
        issue: "개발 주체",
        exclusivity_holder: "Company S",
        confidence: "High",
        reasoning: "S사는 차세대 공정의 기술 요구사항을 제시하고(F001), P사 원천 기술 샘플 평가 후 문제점(연마 효율 저하, 화학적 흡착력 부족)을 구체적으로 진단했습니다(F008). P사도 S사 웨이퍼에서 연마 속도 급감을 확인하며 초기 기술의 한계를 인정했습니다(F011). S사가 제안한 Additive-X 도입 후, P사 Silica Slurry의 치명적 결함이 해결되고 연마 속도와 선택비가 획기적으로 개선되었음이 S사와 P사 모두에 의해 확인되고 동의되었습니다(F018, F022). 이는 S사의 Additive-X가 CMP 공정 성능 개선에 결정적인 역할을 했음을 명확히 보여줍니다.",
        supporting_facts: ["F001", "F002", "F005", "F006", "F007", "F008", "F011", "F012", "F016", "F018", "F022"],
        counter_arguments: "P사가 초기 샘플을 공급하고(F005) 자체 실험실 데이터를 보유했으나(F011), S사 공정에서의 성능 저하를 인정하고 S사 Additive-X의 개선 효과에 동의했으므로 반박 가능성은 낮습니다.",
        recommendation: "S사 Additive-X가 CMP 공정 성능에 미치는 정량적 기여도 데이터를 계약서에 명시하여 S사의 배타권 주장을 더욱 강화할 수 있습니다.",
        legal_basis: {
          applicable_laws: ["PL001", "CL001"],
          contract_analysis: {
            has_exclusivity_clause: true,
            clause_summary: "P사는 S사가 독자 개발한 Additive-X 및 최종 혼합 Slurry 제품(Soul-S2)에 대한 S사 측의 배타적 사용 권리와 제3자 공급 금지 조항을 수용했습니다(F029, F030).",
            validity_period: "양산 보급 후 최소 5년 (F027)",
            enforcement_risk: "P사가 S사 Additive-X의 성능 개선 효과를 명시적으로 인정했으���로, 해당 기술�� 대한 S사의 배타권 주장은 강력한 법적 근거를 가집니다."
          },
          inventorship_analysis: "S사가 CMP 공정의 핵심 문제점을 진단하고(F008), 이를 해결할 Additive-X 아이디어를 제안하여(F014) 성능 개선을 이끌었으므로, 해당 기술의 발명자로 인정될 가능성이 높습니다.",
          contribution_analysis: "S사는 공정 요구사항 제시, 문제점 진단, 핵심 기술 아이디어 제공 및 성능 개선 검증에 주도적으로 기여했습니다. P사는 초기 샘�� 제공 및 S사 기술 적용 후 성능 확인에 기여했습니다.",
          risk_factors: ["P사의 초기 샘플 개발 및 평가 참여가 공동 개발로 해석될 여지"],
          recommended_legal_actions: ["S사 Additive-X가 CMP 공정 성능 개선에 미친 결정적 영향에 대��� 기술 보고서 및 평가 데이터를 법적 증거로 확보"]
        },
        evaluation_grade: {
          tech_effect_grade: "N/A",
          tech_effect_reasoning: "N/A - 소재 과제",
      ...
      },
      {
        ...
        confidence: "Medium",
        reasoning: "S사는 초기 P사 독자 포뮬러의 양산 적용 불가 문제를 지적했고(F007), 최종적으로 Pilot 롯트 평가를 통해 품질 안정 및 양산성 확보를 확인하고 기술 승인을 통보했습니다(F031, F032). 반면, P사는 S사의 Additive-X 아이디어를 반영하여 2차 샘플을 제작하고(F017), 양산 신뢰성 확보를 위한 공동 테스트를 요청했으며(F024), S사 Additive-X의 혼합 및 분산을 위한 양산 공정 설계를 완료하고(F035), S사향 공급을 위한 전용 생산 라인을 지정하는 등(F037) 실제 양산 구현 및 자원 투입에 주도적으로 기여했습니다. 따라서 양산 공정 및 품질 관리 기술은 S사의 핵심 기술을 기반으로 P사가 실제 구현 및 자원 투입을 수행한 공동 개발의 성격이 강합니다.",
        supporting_facts: ["F005", "F006", "F007", "F013", "F017", "F018", "F024"],
        counter_arguments: "S사가 최종 기��� 승인을 통보했으므로(F032) S사의 주도권이 강하다고 볼 수 있으나, P사의 구체적인 양산 공정 설계 및 전용 라인 지정 등 자원 투입은 P사의 기여를 명확히 보여줍니다.",
        recommendation: "양산 공정 설계 및 품질 관리 절차에 대한 S사와 P사의 기여도를 명확히 문서화하고, 해당 공정 기술에 대한 권리 귀속 조항을 계약서에 구체적으로 명시해야 합니다.",
        legal_basis: {
          applicable_laws: ["CV001", "CL001"],
          contract_analysis: {
            has_exclusivity_clause: true,
            clause_summary: "P사는 S사의 Additive-X 및 Soul-S2에 대한 S사의 배타적 사용 권리를 수용했으나(F030), 양산 공정 자체에 대한 권리 귀속은 명확히 언급되지 않았습니다. 다만, P사가 S사향 공급 물량에 대한 보안 관리 및 품질 추적성을 위해 전용 생산 라인을 지정하겠다고 약속했습니다(F037).",
            validity_period: "N/A (양산 공정 자체에 대한 명시적 ���간 없음)",
            enforcement_risk: "양산 공정 기술 자체에 대한 명시적인 권리 귀속 조항이 불분명할 경우, 향후 P사가 해당 공정 기술을 다른 용도로 활용할 때 분쟁의 소지가 있습니다."
          },
          inventorship_analysis: "S사는 양산성 확보의 최종 승인자 역할을 했고(F032), P사는 S사 Additive-X를 활용한 양산 공정 설계 및 구현을 수행했습니다(F035). 양산 공정 기술의 발명자는 공동으로 인정될 가능성이 있습니다.",
          contribution_analysis: "S사는 양산성 목표 제시 및 최종 검증에 기여했고, P사는 실제 양산 공정 설계, 설비 투입(전용 라인 지정), 대량 합성 및 장기 저장 안정성 테스트 요청 등 구현 및 자원 투입에 크게 기여했습니다.",
          risk_factors: ["양산 공정 기술에 대한 명확한 권리 귀속 조항 부재", "P사의 자원 투입 및 구현 기여도에 대한 잠재적 권리 주장"],
          recommended_legal_actions: ["양산 공정 기술에 대한 공동 소유 또는 S사의 전용 실시권 확보를 위한 계약서 보완 검토", "P사의 양산 공정 설계 및 운영 노하우에 대한 비밀유지 계약 강화"]
        },
        evaluation_grade: {
          tech_effect_grade: "N/A",
          tech_effect_reasoning: "N/A - 소재 과제",
      ...
      {
        group_id: "G004",
        topic: "지식재산권 및 배타권 관리",
        issue: "개발 주체",
        exclusivity_holder: "Company S",
        confidence: "High",
        reasoning: "S사는 Additive-X에 대한 보안 유지 및 독점적 권리 보장을 초기부터 강력히 요구했으며(F015, F021), P사도 S사가 독��� 개발한 Additive-X 및 최종 혼합 Slurry 제품(Soul-S2)에 대한 S사의 배타적 사용 권리와 제3자 공급 금지 조항을 명시적으로 수용했습니다(F029, F030). S사는 배타권의 범위(Additive-X 메커니즘 및 최적 조성비), 기간(최소 5년), 관리 방안(내부 DB 등록), 위반 시 제재(페널티 조항)까지 구체적으로 명시하고 P사의 동의를 얻었습니다(F026, F027, F033, F034). P사는 자사의 Silica 원천 기술의 타 제품 활용 제한 없음 전제를 제시했으나(F028), S사의 배타권 조항을 엄격히 준수하겠다고 약속했습니다(F036).",
        supporting_facts: ["F004", "F014", "F015", "F020", "F021", "F023", "F025"],
        counter_arguments: "P사가 고순도 Silica 독자 원천 특허를 보유하고(F004) 자사 기술의 타 제품 활용 제한 없음 전제를 제시했으나(F028), S사의 Additive-X 및 Soul-S2에 대한 배타적 권리를 명시적으로 수용했으므로 반박 가능성은 낮습니다.",
        recommendation: "체결된 배타권 계약서의 모든 조항이 법적으로 완벽하게 구속력을 가지는지 법무팀에서 최종 검토하고, P사의 Silica 원천 기술 활용 범위에 대한 명확한 조항을 재확인해야 합니다.",
        legal_basis: {
          applicable_laws: ["CL002", "PL001", "CL001"],
          contract_analysis: {
            has_exclusivity_clause: true,
            clause_summary: "S사는 Additive-X 메커니즘 및 'Silica + Additive-X'의 최적 조성비가 S사의 배타적 권리 자산임을 명시하고, P사의 제3자 판매/양도/기술 이전을 금지하며 배타권 설정 기간(양산 보급 후 최소 5년)을 명시했습니다. P사는 이를 수용했습니다.",
            validity_period: "양산 보급 후 최소 5년 (F027)",
            enforcement_risk: "P사가 S사의 배타적 권리 및 제3자 공급 금지 조항을 명시적으로 수용하고 준수 의사를 밝혔으므로, 법적 집행 가능성은 매우 높습니다. 페널티 조항 포함 계약 체결 절차 진행(F034)은 집행력을 더욱 강화합니다."
          },
          inventorship_analysis: "S사가 Additive-X라는 고유 아이디어를 제안하고(F014), 주도적으로 기술 및 최적 배합비를 도출했으므로(F020), Additive-X 및 이를 포함한 Soul-S2의 핵심 기술에 대한 발명자는 S사로 인정될 가능성이 높습니다.",
          contribution_analysis: "S사는 핵심 기술 아이디어 제안, 개발 주도, 배타권 범위 및 조건 설정에 결정적으로 기여했습니다. P사는 자사의 원천 기술 제공 및 S사의 배타권 수용을 통해 협력했습니다.",
          risk_factors: ["P사의 Silica 원천 특허(F004)가 S사의 배타권 범위에 영향을 미칠 수 있는 잠재적 해석의 여지"],
          recommended_legal_actions: ["배타권 계약서의 모든 조항(특히 권리 범위, 유효기간, 위반 시 제재)에 대한 법무팀의 최종 검토 및 필요 시 보완", "S사 Additive-X 관련 특허 출원 진행 여부 확인 및 강화"]
        },
        evaluation_grade: {
          tech_effect_grade: "N/A",
          tech_effect_reasoning: "N/A - 소재 과제",
      ...
      applicable_laws: [
        {
          law_id: "PL001",
          law_name: "특허법 제33조 (특허를 받을 수 있는 권리)",
          relevance: "발명자 인정 기준 - 기술적 아이디어를 창출한 자를 특정하는 근거가 됩니다.",
        ...
        },
        {
          law_id: "CL002",
          law_name: "계약 특약 조항 배타적 독점권 조항",
          relevance: "계약서에 명시된 배타적 독점권, 제3자 공급 금지 등의 조항은 권리 귀속을 판단하는 가장 강력한 법적 근거가 됩니다.",
          application_to_project: "S사가 Additive-X의 보안 유지(F015), 독점적 권리 보장 요청(F021) 등 명시적인 배타권 의사를 표현했으며, 2차 샘플 평가에서 Additive-X 기술의 효과를 확인(F018, F022)했습니다. S사는 첨가제 기술 및 최적 배합비를 자신이 주도로 도출했음을 명시(F020)했고, 이러한 기술이 P사 Silica 포뮬러의 결함을 완전히 해결했음을 입증했습니다(F016, F018). 이는 S사의 배타권 주장을 강력하게 뒷받침합니다."
        },
        {
          law_id: "CL001",
          law_name: "계약법 (민법 제664조) 도급계약 - 일의 완성과 보수",
          relevance: "도급 계약에서 일의 완성에 따른 결과물의 소유권은 계약서에 명시된 조항에 따릅니다.",
          application_to_project: "P사는 S사의 요구사항에 따라 샘플을 개발하고 양산 공정을 설계하는 역할을 수행했으므로 도급 계약의 성격이 있습니다. P사가 S사의 Additive-X 및 최종 혼합 Slurry 제품(Soul-S2)에 대한 S사의 배타적 권리를 수용했으므로, 해당 결과물의 소유권은 계약에 따라 S사에 귀속됩니다."
        },
        {
          law_id: "CV001",
          law_name: "민법 제654조 (공유물의 관리)",
          relevance: "공동 개발 시 각자의 ���여도에 따라 지분 비율을 정할 수 있으며, 명시적 합의가 없으면 균등 지분으로 추정될 수 있습니다.",
          application_to_project: "P사가 자사의 고순도 Silica 독자 원천 특허를 보유하고 있으며(F004), S사의 Additive-X와 시너지를 냈다고 평가했으므로(F023), Silica 원천 기술 자체는 P사의 소유로 인정될 수 있습니다. 그러나 Additive-X가 적용된 최종 혼합 Slurry 제품에 대해서는 S사의 기술 기여도가 결정적이므로(F014, F016, F018, F020, F022), 해당 제품에 대한 배타권은 S사가 가집니다."
        },
        {
          law_id: "PL002",
          law_name: "특허법 제10조~제15조 (직무발명)",
          relevance: "협력사 직���이 개발한 경우 직무발명에 대한 권리 귀속을 검토해야 합니다.",
          application_to_project: "S사가 Additive-X를 '고유 아이디어'로 제안하고(F014) '주도적으로 도출'했다고 명시했으며(F020), P사는 S사의 Additive-X 투입으로 인한 성능 개선을 명확히 확인(F016, F022)했습니다. S사가 차세대 공정의 기술 요구사항을 제시(F001)하고 문제점을 진단(F008, F009)한 후 해결책을 제안(F014)했으므로, Additive-X에 대한 직무발명 이슈는 S사에 유리하게 해석될 가능성이 높습니다."
        }
      ],
      overall_legal_analysis: "본 프로젝트의 배타권 판단은 다음 ��거들에 기반합니다. 기술��� 측면: S사는 차��대 공정 요구사항을 제시(F001)하고, P사 기존 기술의 한계(F007-F013)를 진단한 후, Additive-X라는 고유 아이디어를 제안(F014)하여 S사 보안 관리(F015) 하에 개발을 주도(F020)했습니다. 결과적으로 이 기술이 P사 Silica 포뮬러의 치명적 결함을 완전히 해결(F016, F018)하고 연마 속도와 선택비를 획기적으로 개선(F022)했��니다. 계약법적 측면: S사는 배타권 보장을 요청(F021)했고, P사도 Additive-X 투입 후 성능 개선 결과를 확인(F022, F016)하며 기술의 시너지를 인정(F023)했습니다. 법적 평가: S사는 Additive-X의 아이디어 제안 및 개발 주도 측면에서 특허법상 발명자 지위를 주장할 수 있으며, P사는 자사의 Silica 원천 기술(F004)에 대한 권리는 유지하지만 최종 제품에 대해서는 S사의 배타적 권리를 인정했습니다. 양산 공정의 경우 P사의 샘플 개발(F005, F006, F017)이 있었으나, 이는 S사의 독점 제품 생산을 위한 것이므로, 전반적으로 S사의 배타권이 확고하다고 판단됩니다.",
      risk_factors: [
        "P사가 고순도 Silica 독자 원천 특허를 보유(F004)하고 있으며 Silica 제조 원천 기술의 독립적 활용 가능성을 명시했으므로(F023), P사가 자사의 원천 기술을 활용한 유사 제품을 개발할 경우 S사의 Additive-X 기술과의 경계 모호로 인한 분쟁 가능성이 있습니다.",
        "S사의 Additive-X가 현재 데이터(F014, F016, F018, F020, F022)로 증명되고 있지만, 특허 출원 여부와 특허 유효성이 불분명한 경우 장기적 배타권 보호에 위험이 있습니다."
      ],
      recommended_actions: [
        "현재 회의록 기록(F001-F024)을 바탕으로 S사와 P사 간 공식 배타권 계약서를 체결하고, 특히 Additive-X의 기술 범위, 유효기간, 위반 시 제재 조항을 명확히 규정해야 합니다.",
        "차세대 공정 기술 요구사항(F001)에서 최종 기술 승인까지의 전체 개발 과정(F001-F024)을 기술 보고서로 작성하여, S사의 Additive-X에 대한 기술 기여도를 객관적으로 증명해야 합니다.",
        "S사 Additive-X 기술의 특허 출원 절차를 즉시 진행하고, 특히 구체적인 기술 메커니즘(Cu 표면 보호막 형성, 정전기적 인력 제어(F014))과 최적 배합비(0.15wt%(F020))에 대한 신규성 및 진보성을 명확히 기술해야 합니다.",
        "P사의 양산 공정 설계(F005, F006, F017)와 품질 관리 절차에 대한 비밀유지 계약(NDA)을 강화하되, 해당 공정이 S사의 Additive-X 전용 생산을 목적으로 함을 명시하여 S사의 배타권을 보호해야 합니다."
      ]
    },
    elapsed_time: 177.88,
    ...
    legal_perspective: {
      applicable_laws: [
        ...
        },
        {
          law_id: "CV001",
          law_name: "민법 제654조 (공유물의 관리)",
          relevance: "공동 소유물의 관리는 공유자 과반수의 지분으로 결정합니다. 공동 ���발 시 각자의 기여도에 따라 지분 ���율을 정할 수 있습니다.",
