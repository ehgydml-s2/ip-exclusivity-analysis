...
export const analysisResults: Record<string, AnalysisResult> = {
  ...
  SNPR20E1: {
    ...
    judgements: SNPR20E1_JUDGEMENTS,
    _deprecated_judgements: [
      {
        group_id: "G001",
      ...
      },
      {
        ...
        recommendation: "전용 현상액 조성물, 고순도 정제 라인 구축 기술 등 P사가 S사의 요구에 맞춰 개발한 공정 및 품질 관리 기술에 대한 권리 귀속을 계약서에 명확히 정의해야 합니다. S사의 독점적 사용을 보장하되, P사의 개발 기여를 인정하는 방향으로 공동 소유 또는 S사 전용 실시권 부여 등을 고려�� 수 있습니다.",
        legal_basis: {
