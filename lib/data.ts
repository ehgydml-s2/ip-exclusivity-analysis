  ...
  HSP20E1: {
    ...
    legal_perspective: {
      ...
      recommended_actions: [
        ...
        "양산 공급 계약서의 지적재산권 귀��� 조항을 법무팀���서 면밀히 검토하고 필요시 보완해야 합니다."
      ]
    },
    elapsed_time: 266.91,
    ...
    judgements: [
      ...
      },
      {
        ...
        legal_basis: {
          ...
          risk_factors: ["P���의 초기 샘플 개발 및 평가 참여가 공동 개발로 해석될 여지"],
      ...
      },
      {
        ...
        legal_basis: {
          ...
          contract_analysis: {
            ...
            validity_period: "N/A (양산 공��� 자체에 대한 명시적 ���간 없음)",
