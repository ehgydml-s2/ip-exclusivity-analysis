...
export const meetingMinutes: MeetingMinute[] = [
  ...
  },
  {
    ...
    articleUrl: "https://www.kedglobal.com/korean-chipmakers/newsView/ked202404190012",
    scenarioNote: `[모호한 기여도 판단 시나리오 - 공동 기술 통합형]\n목적: 양사가 각자 핵심 기술을 보유하고 공동��로 통합 개발, 기여도 경계 불명확\n- Company S (SK하��닉스): HBM 메모리 기술, 일부 베이스 다이 구조 제안\n- Company A (TSMC): 로직 공정 기술, 일부 베이스 다이 기능 제안\n→ 양측이 모두 핵심 아이디어 제시, 최종 성과는 통합 결과\n→ 누가 더 큰 기여를 했는지 불명확\n→ Agent가 "기여도 불명확, 공동 개발 성과, 추가 증거 필요" 판정 기대`,
  },
  {
    id: "HBM426E1_07",
    numId: 72,
  ...
  },
  {
    ...
    date: "2026-01-13",
    companyS: `배타권 계약 체결\n당사가 제공한 Additive-X의 메커니즘 및 'Silica + Additive-X'�� 최적 조성비는 당사의 배타적 권리 자산임. 따라서 A사��� 본 ��술이 적용된 Slurry 완제품 또는 동일 메커니즘을 가진 제품을 S사의 사전 서면 동의 ��이 글로벌 경쟁사를 포함한 제3자에게 판매, 양도, 또는 기술 이전할 수 없�� (배타권 ��정 기간: 양산 보급 후 최소 5년).`,
  ...
  },
  {
    ...
    date: "2026-03-04",
    companyS: `Pilot 롯트 평가 결과 품질 산포가 안정적이며 양산성 확보가 완료되었음을 확인하여 최종 기술 승인을 통보함. 본 제품은 기술 심의회를 거쳐 당사 내부 '배타권 자��� DB'에 정식 등록될 예정임. 구매팀 주도로 양산 공급 계약 ��� 배타권 위반 시 페널티 조항�� 포함한 정식 계약 체결 절차를 진행��겠음.`,
...
export const analysisResults: Record<string, AnalysisResult> = {
  ...
  HBM20C01: {
    ...
    judgements: [
      ...
      },
      {
        ...
        legal_basis: {
          ...
          contribution_analysis: "P사는 기술 개발 및 특허 확보에 대한 원천적 기여를 했으며, S사는 이 기술의 독점적 사용을 위해 상당한 비용(일시금 40억 원 + 로열티 2.7%)을 지불했습니다. P사의 기술적 기여가 압도적입니다.",
          risk_factors: ["기술이전 범위의 모호성으로 인한 S사의 백업 생산 능력 확보 제한 및 향후 기술 개발 시 분쟁 가능성.", "중국/대만 고객사에 대한 P사의 사전 승인 조건이 S사의 해외 사업 확장에 제약이 될 수 있으며, 승인 거부 시 분쟁 가능성."],
    ...
    legal_perspective: {
      ...
      overall_legal_analysis: "본 프로젝트에서 CMP 슬러리 기술에 대한 배타권은 협력사(P사)에게 강력하게 귀속됩니다. P사는 해당 기술에 대한 독점적인 선행 기술과 특허를 보유하고 있었으며, 이는 특허법 제33조 및 직무발명 규정(PL001, PL002)에 따라 P사의 발명자 권리를 뒷받침합니다. S사는 P사의 기술을 독점적으로 사용하기 위해 배타적 기술협력 계약(ETCA)을 체결하고, 일시금 40억 원과 로열티 2.7%를 지불하기로 합의했습니다. 이 계약에는 P사의 기술에 대한 3년간 독점 공급 및 P사의 독점적 지위 확보 조항(CL002)이 명시되어 있으며, P사는 기술이전 범위 제한, 역설계 방지, 핵심 배합비 비공개 등 강력한 기술 보호 조항을 요구하여 관철시켰습니다. 따라서 S사는 계약에 명시된 기간 동안 P사의 기술이 적용된 CMP 슬러리를 독점적으로 공급받을 권리를 가지지만, 기술 자체의 소유권 및 배타권은 P사에게 있습니다.",
      risk_factors: [
  ...
  SCMP26E1: {
      ...
      },
      {
        ...
        legal_basis: {
          ...
          contract_analysis: {
            ...
            validity_period: "N/A (양산 공정 자체에 대한 명시적 기간 없음)",
    ...
    legal_perspective: {
      ...
      overall_legal_analysis: "본 프로젝트의 배타권 판단은 다음 근거들에 기반합니다. 기술적 측면: S사는 차세대 공정 요구사항을 제시(F001)하고, P사 기존 기술의 한계(F007-F013)를 진단한 후, Additive-X라는 고유 아이디어를 제안(F014)하여 S사 보안 관리(F015) 하에 개발을 주도(F020)했습니다. 결과적으로 이 기술이 P사 Silica 포뮬러의 치명적 결함을 완전히 해결(F016, F018)하고 연마 속도와 선택비를 획기적으로 개선(F022)했습니다. 계약법적 측면: S사는 배타권 보장을 요청(F021)했고, P사도 Additive-X 투입 후 성능 개선 결과를 확인(F022, F016)하며 기술의 시너지를 인정(F023)했습니다. 법적 평가: S사는 Additive-X의 아이디어 제안 및 개발 주도 측면에서 특허법상 발명자 지위를 주장할 수 있으며, P사는 자사의 Silica 원천 기술(F004)에 대한 권리는 유지하지만 최종 제품에 대해서는 S사의 배타적 권리를 인정했습니다. 양산 공정의 경우 P사의 샘플 개발(F005, F006, F017)이 있었으나, 이는 S사의 독점 제품 생산을 위한 것이므로, 전반적으로 S사의 배타권이 확고하다고 판단됩니다.",
      risk_factors: [
  ...
  SNPR20E1: {
    ...
    judgements: [
      {
        group_id: "G001",
        topic: "Sn 무기물 PR 소재 기술",
        issue: "원천 기술 보유 및 초기 검토 주체",
        exclusivity_holder: "Partner",
        confidence: "Medium",
        reasoning: "COMPANY_P(인프리아)는 Sn 원천 기술과 1세대 샘플을 이미 보유하고 있음을 명확히 밝혔습니다(F007). COMPANY_S는 차세대 EUV 공정 적용을 위해 이 소재의 기본 물성 검토를 요청하고(F001), 높은 흡수율을 확인했으나 균일도 문제를 인지하는 등(F003) 초기 평가 및 개선 필요성을 제기했습니다. IP-B20 샘플은 S사의 아이디어와 P사의 원천 기술이 결합된 것으로 언급되었으나(F021), 'Sn 무기물 PR 소재 기술' 자체의 근본적인 원천은 P사에 있습니다.",
      ...
      },
      {
        ...
        legal_basis: {
          ...
          contract_analysis: {
            has_exclusivity_clause: true,
            clause_summary: "P사가 S사의 독자적 제안임을 인정하고 배타적 보호 필요성을 인정(F040). P사가 특정 리간드 구조체에 S사 독점권 부여 검토(F088).",
      ...
      },
      {
        ...
        recommendation: "전용 현상액 조성물, 고순도 정제 라인 구축 기술 등 P사가 S사의 요구에 맞춰 개발한 공정 및 품질 관리 기술에 대한 권리 귀속을 계약서에 명확히 정의해야 합니다. S사의 독점적 사용을 보장하되, P사의 개발 기여를 인정하는 방향으로 공동 소유 또는 S사 전용 실시권 부여 등을 고려할 수 있습니다.",
        legal_basis: {
          ...
          recommended_legal_actions: ["공정 기술에 대한 권리 귀속 조항을 계약서에 명확히 포함하고, S사의 독점적 사용을 보장하는 전용 실시권 또는 공동 소유를 검토할 것."]
        },
        evaluation_grade: {
          tech_effect_grade: "N/A",
          tech_effect_reasoning: "N/A - 소재 과제",
      ...
      },
      {
        ...
        exclusivity_holder: "Joint",
        confidence: "Medium",
        reasoning: "COMPANY_S는 양산화를 위한 안정성 검증 단계 진입을 판단하고(F066), 항산화 안정제 첨가(F072), 특수 차광 및 내벽 코팅 전용 캔 개발(F073), 6개월 이상 보존 기간 보장(F074) 등 구체적인 요구사항과 목표를 제시했습니다. COMPANY_P는 S사의 지적에 동의하고(F075), 겔화 억제제 최적 배합비를 도출하며(F077), A사 보유 특수 테프론 코팅 용기를 적용하여(F076) S사의 요구를 충족시키고 6개월 이상 보존 기간을 보장하겠다고 결정했습니다(F078). 이는 S사의 요구사항을 바탕으로 P사가 구체적인 기술 개발 및 구현을 수행한 공동의 결과로 판단됩니다.",
      ...
      },
      {
        ...
        recommendation: "최종 계약서 서명 전, S사의 배타권 범위와 P사의 원천 기술 및 제조 독점권 범위가 상호 명확하게 정의되어 있는지 재확인해야 합니다. 특히 '유도체 일체'의 범위에 대한 해석의 여지를 최소화해야 합니다.",
        legal_basis: {
          applicable_laws: ["CL002", "PL001", "PL002"],
          contract_analysis: {
            has_exclusivity_clause: true,
            clause_summary: "S사가 '분지형 할로겐 말단 치환 구조'에 대한 배타권 조항이 포함된 계약서 최종안을 발송(F094)했으며, P사가 5년간 경쟁사 공급 금지 조항을 수용(F090)하고 특정 리간드 구조체에 S사 독점권 부여를 검토(F089)하기로 합의함.",
            validity_period: "5년 (F090)",
      ...
      },
      {
        ...
        legal_basis: {
          ...
          contribution_analysis: "S사는 개발 완료 및 배타권 확보의 최종 단계에서 주도적인 역할을 수행했습니다.",
    ...
    legal_perspective: {
      applicable_laws: [
        ...
        },
        {
          law_id: "CV001",
          law_name: "민법 제654조 (공유물의 관리)",
          relevance: "공동 소유물의 관리는 공유자 과반수의 지분으로 결정합니다. 공동 개발 시 각자의 기여도에 따라 지분 비율을 정할 수 있습니다.",
